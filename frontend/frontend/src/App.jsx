    ...
    <div style={{
      ...
      <header style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '8px', flexShrink: 0 }}>
          ...
          <span style={{ fontWeight: 'bold', fontSize: '16px' }}>FireWatch SAR</span>
        </div>
        ...
        <div style={{ flex: 1, minWidth: '200px', maxWidth: '380px', position: 'relative' }}>
          <input
            type="text"
            placeholder="🔍 Search any region or country..."
            value={searchQuery}
        ...
        {layers.hotspots?.data && (
          <div style={{
            ...
            🔴 {layers.hotspots.data.features?.length?.toLocaleString()} hotspots
          </div>
        )}
      </header>
