...
function AppInner() {
  ...
  // Mirrors FireMap's internal "Solo focos forestales" toggle (FireMap owns
  // the actual UI checkbox and its own visibleLayers state) — lifted here
  // only so Sidebar's world/country/state/zone counts can react to it too.
