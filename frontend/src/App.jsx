...
export default function App() {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", height: "100vh", width: "100vw",
      background: "#0a0a0a", color: "#ffffff", fontFamily: "system-ui, -apple-system, sans-serif", overflow: "hidden" }}>

      <header style={{ background: "#1a2a3a", borderBottom: "2px solid #2e5b8a",
        ...
        <div style={{ flex: 1, minWidth: "200px", maxWidth: "380px", position: "relative" }}>
          ...
          {searchResults.length > 0 && (
            <div style={{ position: "absolute", top: "100%", left: 0, right: 0,
              ...
              borderRadius: "6px", marginTop: "4px", zIndex: 2000, overflow: "hidden" }}>
        ...
        {layers.hotspots?.data && (
          <div style={{ marginLeft: "auto", background: "#5a0000", border: "1px solid #cc3300",
            borderRadius: "12px", padding: "4px 10px", fontSize: "12px", color: "#ffaaaa", flexShrink: 0 }}>
